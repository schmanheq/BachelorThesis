...
if __name__ == '__main__':
    ...
    def training_baselines():
        start = time.time()
        process_graph_path = "dataset0/inference_processed_data/processed_graphs_dataset0_low"
        model_path = 'baseline_svd_dataset0_low.pkl'
        baseline_training(process_graph_path, model_path)
        end = time.time()
        print(end-start)
